  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-5 top-8 z-30 hidden h-11 w-11 items-center justify-center rounded-full border border-white/70 bg-gradient-to-br from-slate-950 to-indigo-600 text-white shadow-[0_14px_35px_rgba(30,41,59,0.28)] ring-4 ring-white/85 transition hover:-translate-y-0.5 hover:from-indigo-600 hover:to-cyan-500 md:inline-flex"
      >
        {isExpanded ? <FiChevronLeft size={20} /> : <FiChevronRight size={20} />}
      </button>
      <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-xl md:shadow-sm">
